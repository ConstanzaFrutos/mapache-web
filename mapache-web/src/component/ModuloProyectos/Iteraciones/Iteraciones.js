            ...
            <div className="tablaIteraciones" >
                <Card className="tablaCrearIteracion" style={{width:"70%", borderColor: this.colorEstado(this.state.iteracionActual), borderWidth: "10px"}}>
                    ...
                    {this.state.iteracionActual ?
                        <Form id="formularioIterEditar" onSubmit={this.actualizarIteracion} classname={"tablaCreariteracion"}>
                            <Form.Row>
                                <Form.Group as={Col}>
                        ...
                        <Table>
                            ...
                            <tbody>
                                {this.state.tareas.length === 0 ?
                                    <tr align="center" >
                                        <td colSpan="3">La iteracion no contiene tareas</td>
                                    </tr> :
                                            ...
                                            <td>
                                                <ButtonGroup>
                                                    <Link to={"/proyectos/"+proyectoId+'/tareas/'+tarea.id}>
                                                        <Button variant={"editIcon"} size="sm">
                                                            <InfoOutlined
                                                                icon={"editIcon"}
                                                            />
                                                        </Button>
                                                    </Link>
                                                    <Button size="sm" variant={"editIcon"} onClick={this.eliminarTarea.bind(this, tarea.id)}>
                                                        <Delete
                                                            icon={"Delete"}
                                                        />
                                                    </Button>
